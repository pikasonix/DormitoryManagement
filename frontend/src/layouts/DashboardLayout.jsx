...
const DashboardLayout = () => {
  ...
  const navigation = useMemo(() => {
    const allNavItems = [
      ...
      { name: 'Yêu cầu sửa chữa', href: '/maintenance', icon: WrenchScrewdriverIcon, roles: ['STUDENT'] }, { name: 'Quản lý hóa đơn', href: '/invoices', icon: DocumentTextIcon, roles: ['ADMIN', 'STAFF'] },
