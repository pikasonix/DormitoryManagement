...
const student_invoice_routes_1 = __importDefault(require("./student-invoice.routes"));
...
router.use('/student/invoices', student_invoice_routes_1.default);
...
router.use('/vnpay', vnpay_1.default);
